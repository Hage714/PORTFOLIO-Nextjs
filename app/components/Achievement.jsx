...
const Achievement = () => {
  return (
    <div className='py-8 px-4 xl:gap-16 sm:py-16 xl:px-16'>
        <div className='border-slate-600 border rounded-md py-8 px-16 flex flex-row items-center justify-between'>
            ...
            <div key={index} className='flex flex-col items-center justify-center mx-4'>
                <h2 className='text-black text-4xl font-bold flex flex-row'>
                    ...
                    <AnimatedNumbers includeComma animateToNumber={parseInt(achievement.value)}
                        locale='en-US' className='text-black text-4xl font-bold' configs={(_, index) => {
                             return {
                                mass: 1,
                                friction: 100,
