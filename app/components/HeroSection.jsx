          ...
          >
            <h1 className="text-black mb-4 text-4xl sm:text-5xl lg:text-6xl lg:leading-normal font-extrabold">
              ...
              <TypeAnimation
                sequence={[
                  "Hage",
                  1000, // wait 1s before replacing "Hage" with "a Web Developer"
                  "a Web Developer",
                  1000,
                  "a Software Engineer",
                  1000,
            ...
            <p className="text-gray-800 text-base sm:text-lg lg:text-xl mb-6">
              I am Hage Woche, a software developer with a specialization in JavaScript. I create innovative solutions that solve real-world problems and enhance user experiences. Explore my work to see how I bring ideas to life through code, and feel free to reach out if you are interested in collaborating or learning more about my projects. Let&apos;s build something amazing together!
            </p>
            <div>
              <a href="#contact">
